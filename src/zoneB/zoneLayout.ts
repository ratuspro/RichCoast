...
// absolute (zone B spans y=412..952, x=0..390 — the band was re-authored from the old
// 358..844 with the linear remap newY = 412 + (oldY−358)×(540/486), so the cascade fills
// the taller band; diagonals are ~11% steeper as a result). Multipliers are tuned for
...
const FUNNEL_RAMPS: WallDef[] = [
  { x1: 0,   y1: 859, x2: 110, y2: 948 },
  { x1: 390, y1: 859, x2: 280, y2: 948 },
];
const BOTTOM_COLLECTOR: CollectorDef = { x: 110, y: 914, width: 170, height: 24, scoreMultiplier: 1 };
...
// post is centred in each gap and starts at the bar's centreline (cy=509), so the gates read
// as framed between two walls (matching the reference).
export const LAYOUT_1: ZoneBLayout = {
  gates: [
    // Row 1 — gaps at x∈[100,116] and x∈[248,264].
    { type: 'static', cx: 54,  cy: 509, angle: 0, length: 92,  multiplier: 4 },
    { type: 'static', cx: 182, cy: 509, angle: 0, length: 132, multiplier: 3 },
    { type: 'static', cx: 323, cy: 509, angle: 0, length: 118, multiplier: 2 },
    // Row 2
    { type: 'static', cx: 45,  cy: 664, angle: 0, length: 85,  multiplier: 2 },
    { type: 'static', cx: 195, cy: 664, angle: 0, length: 110, multiplier: 2 },
    { type: 'static', cx: 348, cy: 664, angle: 0, length: 80,  multiplier: 2 },
    // Row 3
    { type: 'static', cx: 195, cy: 792, angle: 0, length: 90,  multiplier: 2 },
  ],
  collectors: [BOTTOM_COLLECTOR],
  walls: [
    // Row-1 gate dividers, centred in the gaps and framing the three top gates.
    { x1: 108, y1: 504, x2: 108, y2: 586 },
    { x1: 256, y1: 504, x2: 256, y2: 586 },
    // Frame posts rising above the right (X2) gate, as in the reference.
    { x1: 264, y1: 472, x2: 264, y2: 509 },
    { x1: 382, y1: 472, x2: 382, y2: 509 },
    // Left outer rail: straight down the left side, then a diagonal converging to centre.
    { x1: 75,  y1: 536, x2: 75,  y2: 681 },
    { x1: 75,  y1: 681, x2: 165, y2: 792 },
    // Right outer rail: straight down the right side, then a diagonal converging to centre.
    { x1: 320, y1: 536, x2: 320, y2: 681 },
    { x1: 320, y1: 681, x2: 230, y2: 792 },
    // Post above the row-2 centre gate.
    { x1: 140, y1: 623, x2: 140, y2: 664 },
    // Small end caps on the row-3 centre gate.
    { x1: 150, y1: 792, x2: 150, y2: 816 },
    { x1: 240, y1: 792, x2: 240, y2: 816 },
    ...FUNNEL_RAMPS,
  ],
};
...
export const LAYOUT_2: ZoneBLayout = {
  gates: [
    ...
    { type: 'static', cx: 105, cy: 509, angle: 0, length: 180, multiplier: 4 },
    { type: 'static', cx: 252, cy: 509, angle: 0, length: 82,  multiplier: 3 },
    { type: 'static', cx: 348, cy: 509, angle: 0, length: 78,  multiplier: 4 },
    // Row 2
    { type: 'static', cx: 95,  cy: 670, angle: 0, length: 170, multiplier: 4 },
    { type: 'static', cx: 250, cy: 670, angle: 0, length: 85,  multiplier: 2 },
    { type: 'static', cx: 345, cy: 670, angle: 0, length: 85,  multiplier: 3 },
    // Row 3
    { type: 'static', cx: 100, cy: 792, angle: 0, length: 120, multiplier: 2 },
    { type: 'static', cx: 300, cy: 792, angle: 0, length: 140, multiplier: 3 },
  ],
  collectors: [BOTTOM_COLLECTOR],
  walls: [
    // Row-1 gate dividers, centred in the gaps and rising slightly above the bars.
    { x1: 203, y1: 475, x2: 203, y2: 536 },
    { x1: 301, y1: 475, x2: 301, y2: 536 },
    // Upper diagonal "\" off the left divider, down-left toward the row-2 left gate.
    { x1: 203, y1: 536, x2: 150, y2: 636 },
    // Tall right rail: the right divider runs straight down past row 2 into row 3,
    // forming the right wall of the central channel.
    { x1: 301, y1: 536, x2: 301, y2: 781 },
    // Lower zig-zag diagonal from below the row-2 centre gate down to the row-3 right gate.
    { x1: 207, y1: 681, x2: 250, y2: 781 },
    // Short vertical cap on the far left of row 3.
    { x1: 40,  y1: 731, x2: 40,  y2: 794 },
    ...FUNNEL_RAMPS,
  ],
};
